export default class Assert {
  static toBeType(obj, type, msg) {
    if (typeof obj !== type) { throw new Error(msg || `Expected object of type ${typeof obj} to be of type ${type}`); }
  }

  static toBeInstanceOf(obj, clazz, msg) {
    if (!(obj instanceof clazz)) { throw new Error(msg || `Expected object to be instance of ${clazz.name}`); }
  }
  ...
  static toBeInteger(obj, msg) {
    ...
    if (Number.isNaN(parsed)) { throw new Error(msg || `Expected ${obj} to be an integer`); }
    return parsed;
  }

  static toNotBeNullOrUndefined(obj, msg) {
    if (obj === null || typeof obj === 'undefined') { throw new Error(msg || 'Object must be defined'); }
    return obj;
  }

  static toBeTruthy(obj, msg) {
    if (!obj) { throw new Error(msg || `Expected ${obj} to be truthy`); }
    return obj;
  }

  static toBeArray(obj, msg) {
    if (!Array.isArray(obj)) { throw new Error(msg || `Expected ${obj} to be an array`); }
    return obj;
  }
