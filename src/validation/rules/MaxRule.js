...
export default class MaxRule extends Rule {
    constructor(args) {
        ...
        expectValidArgumentType(
            maxArg,
            'Expected string, function, number, or date for rule argument'
        );
    ...
    performChecks(value) {
        if (value == null || typeof value === 'undefined') return Promise.resolve();
            ...
            return this.limitArg(value) ? Promise.resolve() : Promise.reject();
        }
    ...
    validate(value) {
        ...
        return this.valueExceedsLimit(comparisonValue, this.limitArg)
